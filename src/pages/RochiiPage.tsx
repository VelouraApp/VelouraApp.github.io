...
// Mock product data for wedding dresses
const products = [
  {
    id: 101,
    ...
    category: 'Rochii',
    price: 4599,
    image: 'https://images.unsplash.com/photo-1596783074918-c84cb1bd5d44?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    id: 102,
    name: 'Rochie Prințesă Diamond',
    category: 'Rochii',
    price: 5299,
    image: 'https://images.unsplash.com/photo-1585241920473-b472eb9ffbae?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    id: 103,
    name: 'Rochie Sirenă Deluxe',
    category: 'Rochii',
    price: 3899,
    image: 'https://images.unsplash.com/photo-1594612894463-3461538f8d9a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    id: 104,
    name: 'Rochie Clasică Ivory',
    category: 'Rochii',
    price: 4199,
  ...
  {
    id: 105,
    name: 'Rochie Modernă cu Perlă',
    category: 'Rochii',
    price: 4799,
    image: 'https://images.unsplash.com/photo-1567532696330-62a19f00da17?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
];

export default function RochiiPage() {
  return (
    <div className="py-8">
      <div className="wedding-container">
        <h1 className="wedding-title mb-8 text-center">Rochii de Mireasă</h1>
